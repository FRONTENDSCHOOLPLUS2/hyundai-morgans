...
// //   return (
// //     <main className="min-w-[320px] p-4  dark:text-black dark:bg-white">
// //       <div className="text-center py-4">
// //         <h2 className="text-2xl font-bold text-gray-700">시승신청 수정</h2>
// //       </div>
// //       <section className="mb-8 p-4">
// //         <form action={`/${params.boards}/${params.id}`}>
// //           <div className="my-4">
