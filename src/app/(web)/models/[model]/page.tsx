    ...
    <>
      ...
      <section className="relative w-screen h-[430px] bg-black text-white z-[-1]">
        <article className="absolute z-10 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[1200px] text-center">
          ...
          <p className="text-[20px] font-light">
            ...
            철학인'역동적인 우아함'으로 재해석한 진정한 블랙의 경험을 제네시스
            G90 Black으로 선사합니다.
          </p>
        </article>
      ...
      <section className="bg-black h-[540px] flex">
        ...
        <article className="flex-[1_1_auto] self-center px-[10%]">
          ...
          <p className="text-[20px] text-[#888] leading-[1.2]">
            제네시스의 디자인 철학인 '역동적인 우아함'이 블랙을 더 깊이 있게
            만들어 줍니다. 완벽한 블랙이 파라볼릭 라인1의 우아한 선을 뚜렷하게
            강조해, 차량을 이루고 있는 곡선과 직선을 조화롭게 드러냅니다.
          </p>
        </article>
      </section>
      ...
      <section className="bg-black min-h-[450px] flex">
        <article className="flex-[1_1_auto] self-center px-[10%]">
          ...
          <p className="text-[20px] text-[#888] leading-[1.2]">
            제네시스의 디자인 철학인 '역동적인 우아함'이 세심하게 설계된 실내
            요소들에 깊이 있는 블랙을 더해, 차분하면서도 우아한 실내 인테리어
            디자인을 완성했습니다. 단순히 어둡기만 한 공간이 아닌, 한 차원 더
            높은 블랙 공간을 구현하기 위해 각각 다른 톤과 명도를 적용해 입체감이
            드러나도록 했습니다. 눈길이 잘 닿지 않는 작은 소재까지도 섬세하게
            디자인함으로써 차별화된 블랙 경험을 선사합니다.
          </p>
        </article>
        <figure className="bg-slate-400 h-full flex-[1_0_900px] overflow-hidden">
          <img
