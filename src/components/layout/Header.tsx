            ...
            <div className="siteItemWrap">
              ...
              <article>
                ...
                <div>
                  ...
                  <Link href='#' onClick={(e) => handleSitemapClick(e,15)}>공지사항</Link>
                  <Link href='#' onClick={(e) => handleSitemapClick(e,16)}>어쩌구</Link>
                  <Link href='#' onClick={(e) => handleSitemapClick(e,17)}>저쩌구</Link>
                </div>
              </article>
